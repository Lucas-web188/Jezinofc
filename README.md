...
local Window = OrionLib:MakeWindow({Name = "jezinofc hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "jezinofc hub"})
...
W:AddLabel("[+] jezinofc hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "jezinofc hub(Noitification)",
